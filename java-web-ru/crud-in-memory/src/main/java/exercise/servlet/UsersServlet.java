...
public class UsersServlet extends HttpServlet {
    ...
    private void newUser(HttpServletRequest request,
        ...
        request.setAttribute("usert", users);
        request.setAttribute("error", "");

        RequestDispatcher o = request.getRequestDispatcher("/new.jsp");
    ...
    private void updateUser(HttpServletRequest request,
        ...
        String lastName = request.getParameter("lastName");
        String email = request.getParameter("email");
        Map<String, String> userCurrent = new HashMap<>();

        userCurrent.put("id", id);
        userCurrent.put("firstName", firstName);
        userCurrent.put("lastName", lastName);
        userCurrent.put("email", email);
